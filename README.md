...
**19 external PRs** as of 10 Sep 2026 (IST): **12 open**, **3 merged**, **4 closed (not merged)**. Plus **9 pipeline / skip** rows.
...
| [TanStack/router](https://github.com/TanStack/router) | [#8237](https://github.com/TanStack/router/issues/8237) Shape 1 | Missing `x-tsr-serverFn` header returns unhandled 500. Already owned by [#8220](https://github.com/TanStack/router/pull/8220). This ledger's #8285 only covers Shape 2. Do not duplicate Shape 1. |
| [better-auth/better-auth](https://github.com/better-auth/better-auth) | [#11208](https://github.com/better-auth/better-auth/pull/11208) | Regression test was merged upstream; retained here only as historical context. |
