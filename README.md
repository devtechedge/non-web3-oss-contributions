...
**16 external PRs** as of 10 Sep 2026 (IST): **12 open**, **2 closed (not merged)**, **2 merged**. Plus **9 pipeline / skip** rows.
...
- Latest open: [brianc/node-postgres#3772](https://github.com/brianc/node-postgres/pull/3772), 10 Sep 2026
